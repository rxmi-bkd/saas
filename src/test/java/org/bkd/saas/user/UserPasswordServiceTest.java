...
class UserPasswordServiceTest {
  ...
  void updateUserPassword_shouldThrowPasswordMismatchException_whenOldPasswordDoesNotMatch() {
    ...
    assertThatThrownBy(() -> userPasswordService.updateUserPassword(USER_ID, USER_PASSWORD, "_")).isInstanceOf(
  ...
  void updateUserPassword_shouldThrowUserNotFoundException_whenUserDoesNotExist() {
    ...
    assertThatThrownBy(() -> userPasswordService.updateUserPassword(USER_ID, USER_PASSWORD, "new_password")).isInstanceOf(
